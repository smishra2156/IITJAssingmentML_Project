...
def diabetes_prediction(input_data):
    loaded_model = pickle.load(open(os.path.abspath('trained_diabetes_model_knn.sav'), 'rb'))
...
if submitted:
    ...
    try:
        diagnonis = diabetes_prediction(input_data)
        st.success(f"Prediction: {diagnonis}")
